...
```{r category-analysis, fig.height=3, fig.width=5, fig.align='center'}
...
# Calculate percentages and positions for labels
  ...
  ggplot(pie_data, aes(x = "", y = total_sales, fill = category)) +
    ...
    scale_fill_manual(values = c("#FF6F20", "#FF3D7F", "#28A745", "#FFC107")) +
    labs(
...
```{r subcategory-analysis, fig.height=3, fig.width=6, fig.align='center'}
